...
from flask import (
    Blueprint, render_template, request, jsonify, abort, flash, url_for, redirect, json
)
...
@crossdomain(origin=basestring, methods=["POST", "PUT", "OPTIONS"], headers="Content-Type")
@login_required
def submit_loop():
    req = request.get_json()
